      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-4">
            <Bot className="text-green-400 mr-3" size={32} />
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-gray-900 bg-opacity-90 border border-green-400 rounded-xl p-6 backdrop-blur-sm hover:border-green-300 transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-white">What is Silent Mode?</h3>
            </div>
              ...
              {features.map((feature, index) => (
                <div key={index} className="bg-black border border-green-400 rounded-lg p-4">
                  <div className="flex items-center mb-2">
                    {feature.icon}
                    <h4 className="text-white font-semibold ml-2 text-sm">{feature.title}</h4>
                  </div>
          ...
          <div className="bg-gray-900 bg-opacity-90 border border-green-400 rounded-xl p-6 backdrop-blur-sm hover:border-green-300 transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-white">Implementation Methods</h3>
            </div>
            
            <div className="space-y-6">
              <div className="bg-black border border-green-400 rounded-lg p-4">
                <div className="flex items-center mb-3">
                  <Code className="text-green-400 mr-2" size={16} />
                  <h4 className="text-green-400 font-semibold text-sm">PowerShell Command</h4>
                </div>
              ...
              <div className="bg-black border border-green-400 rounded-lg p-4">
                <div className="flex items-center mb-3">
                  <Settings className="text-green-400 mr-2" size={16} />
                  <h4 className="text-green-400 font-semibold text-sm">Batch File (.bat)</h4>
                </div>
                <div className="bg-gray-900 border border-gray-700 rounded p-3">
              ...
              <div className="bg-black border border-green-400 rounded-lg p-4">
                <div className="flex items-center mb-3">
                  <Bot className="text-green-400 mr-2" size={16} />
                  <h4 className="text-green-400 font-semibold text-sm">Scheduled Task</h4>
                </div>
                <div className="bg-gray-900 border border-gray-700 rounded p-3">
                  <code className="text-green-400 text-xs">
          ...
          <div className="bg-gray-900 bg-opacity-90 border border-green-400 rounded-xl p-6 backdrop-blur-sm hover:border-green-300 transition-all duration-300">
            ...
            <div className="bg-black border border-green-400 rounded-lg p-4 mb-6">
              <h4 className="text-green-400 font-semibold mb-3 text-sm">Advanced Features</h4>
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 bg-green-600 text-black font-bold py-3 px-4 rounded-lg hover:bg-green-700 transition-all duration-300 transform hover:scale-105 text-sm w-full"
            >
        ...
        {/* Important Notes */}
        <div className="bg-gray-900 bg-opacity-90 border border-yellow-400 rounded-xl p-6 backdrop-blur-sm">
          <div className="flex items-center mb-6">
            <Settings className="text-yellow-400 mr-3" size={24} />
            <h3 className="text-2xl font-bold text-yellow-400">Implementation Guidelines</h3>
          </div>
          
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              <h4 className="text-white font-semibold mb-3 text-lg">Before Deployment</h4>
            ...
            <div>
              <h4 className="text-white font-semibold mb-3 text-lg">During Execution</h4>
              <ul className="text-gray-300 text-sm space-y-2">
            ...
            <div>
              <h4 className="text-white font-semibold mb-3 text-lg">Post-Activation</h4>
              <ul className="text-gray-300 text-sm space-y-2">
